<?php
$page_title = (isset($_GET['cat_id'])) ? 'تعديل فئة' : 'اضافة فئة ';
include("includes/header.php");
require("includes/lb_helper.php");
require("language/language.php");
require_once("thumbnail_images.class.php");

$page_save = (isset($_GET['cat_id'])) ? 'حفظ' : 'انشاء';
                ...
                <form action="" name="addeditcategory" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="category_name" class="form-control" value="<?php if (isset($_GET['cat_id'])) {
