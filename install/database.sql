...
--
-- Host: localhost:3306
-- Generation Time: Oct 28, 2022 at 07:22 AM
...
(1, 'Driving Exam', '64483_logo.jpg', 'info.nemosofts@gmail.com', 'nemosofts', '0356525684', 'nemosofts.com', 'Love this app? Let us Know in the Google Play Store how we can make it even better', 'thivakaran', '', '', '', '', '', '', '', '', '', 20, 20, 'cid', 'DESC', '', 'admob', 'ca-app-pub-3940256099942544~3347511713', '2347511713', '0047511713', '3747511700', 'true', 'ca-app-pub-3940256099942544/6300978111', '3347511713', '54353153486156', 'true', 'ca-app-pub-3940256099942544/1033173712', '3347511713', '54353153486156', 5, 'true', 'ca-app-pub-3940256099942544/2247696110', '3347511713', '54353153486156', 6, 'true', 20, 'true', 'https://camo.envatousercontent.com/47d826c1e095bc24a744c5f014330a03318ae300/68747470733a2f2f646f776e6c6f61642e6e656d6f736f6674732e636f6d2f656e7661746f2f72657364657369676e2e706e67', 'https://codecanyon.net/user/nemosofts', 12, 'false', 'false', 'false', 'false', 'false', 'true', 'true', 'false', 'false', 'false', 'false', 'false', 'false', 1, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_signs`
--

CREATE TABLE `tbl_signs` (
  `id` int(11) NOT NULL,
  `lan_id` int(11) NOT NULL,
  `cat_id` int(11) NOT NULL,
  `signs_name` varchar(255) NOT NULL,
  `signs_image` varchar(255) NOT NULL,
  `status` int(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `tbl_signs`
--
ALTER TABLE `tbl_signs`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_signs`
--
ALTER TABLE `tbl_signs`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
