...
<head>
    ...
    <!-- Website Title -->
    <title>استعادة كلمة المرور | <?php echo APP_NAME; ?></title>
                ...
                <div class="pb-card__body">
                    <form action="login_db.php" method="post" class="text-left">
                        <div class="text-center mb-4">
                            ...
                            <p>ادخل بريدك وسنرسل تعليمات الاستعادة لك</p>
                        </div>
                        <div class="mb-2">
                            <label class="form-label">البريد الالكتروني</label>
                            <input type="text" name="email" id="email" class="form-control">
                        </div>
                        <button type="submit" class="btn btn-primary mt-4">استعادة</button>
                        <div class="pb-auth__copy text-center mt-4">
                            <p class="">اذهب لشاشة الدخول <a href="index.php"> تسجيل الدخول</a></p>
                        </div>
                    </form>
                </div>
            </div>
