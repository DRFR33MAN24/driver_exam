        ...
        <div class="pb-card">
            <div class="pb-card__head d-sm-flex align-items-sm-center">
                ...
                <div class="pb-card__head__option">
                    <form method="get" id="searchForm" action="">
                        <div class="pb-card__head__option__item">
                            <div class="input-group input-group-sm">
                                <input type="text" id="search_input" class="form-control" placeholder="ابحث هنا" name="keyword" value="<?php if (isset($_GET['keyword'])) {
                                                                                                                                            echo $_GET['keyword'];
                                                                                                                                        } ?>" required="required">
                    ...
                    <div class="pb-card__head__option__item">
                        <a href="add_category.php?add=yes" class="btn btn-sm btn-primary">+ <span class="d-none d-sm-inline-block">اضف فئة</span></a>
                    </div>
                </div>
            </div>
