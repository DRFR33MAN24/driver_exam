...
{
    global $mysqli;
    $qry_songs = "SELECT COUNT(*) as num FROM tbl_quiz WHERE lan_id='" . $cat_id . "'";
    ...
    <div class="pb-main-container">
        <div class="pb-card">
            ...
            <div class="pb-card__body py-4">
                        ...
                        while ($row = mysqli_fetch_array($result)) { ?>
                            <div class="col-md-4 col-sm-6">
                                <div class="pb-card-post-text">
                                    ...
                                    <h6 class="card-title">عدد الاسئلة<?php echo get_total_post($row['lid']); ?></h6>
                                    <a href="manage_questions.php?lan_id=<?php echo $row['lid']; ?>" class="btn btn-success btn_cust bs-tooltip mt-2">
                                        <i class="fa fa-history">ادارة الاسئلة</i>
                                    </a>
                                </div>
                            </div>
                        <?php $i++;
                ...
                <?php } else { ?>
                    <ul class="p-5">
                        <h1 class="text-center">لم يتم ايجاد اسئلة</h1>
                    </ul>
                <?php } ?>
                <!-- Begin:: Pagination -->
