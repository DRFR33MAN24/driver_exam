                ...
                <nav>
                    <div class="nav nav-tabs" id="nav-tab" role="tablist">
                        ...
                        <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">
                            <svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-navigation">
                    ...
                    <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                        <div class="row mt-4">
                            <form action="" name="addeditone" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-sm-3 col-form-label">الرسالة</label>
                                    <div class="col-sm-9">
                                        <textarea name="notification_msg" id="notification_msg" class="form-control" required></textarea>
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-sm-3 col-form-label">اختر الصورة</label>
                                    <div class="col-sm-9">
                    ...
                    <div class="tab-pane fade" id="nav-contact" role="tabpanel" aria-labelledby="nav-contact-tab">
                        <div class="row mt-4">
                            <form action="" name="addedituser" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-sm-3 col-form-label">مستخدم</label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-sm-3"></div>
                                    <div class="col-sm-9">
                                        <button type="submit" name="user_submit" class="btn btn-primary" style="min-width: 100px;">حفظ</button>
                                    </div>
                                </div>
                            </form>
                        </div>
