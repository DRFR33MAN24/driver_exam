                        ...
                        <div class="row">
                            <form action="" name="settings_app" method="POST" enctype="multipart/form-data">
                                <div class="form-group row mb-4 mt-4">
                                    ...
                                    <div class="col-sm-9">
                                        <label class="switch">
                                            <input type="checkbox" id="isRTL" name="isRTL" value="true" class="cbx hidden" <?php if ($settings_data['isRTL'] == 'true') {
                                                                                                                                echo 'checked';
                                                                                                                            } ?> />
                        ...
                        <div class="row">
                            <form action="" name="settings_api" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row mb-4 mt-4 ">
                                    <div class="col-sm-6">
                                        <div class="form-group row mb-4">
                                            <label class="col-sm-3 col-form-label">img questions Limit</label>
                                        ...
                                        <div class="form-group row ">
                                            <label class="col-sm-3 col-form-label">none img questions Limit</label>
                                            <div class="col-sm-8 col-lg-8">
                                        ...
                                        <div class="ads_view">
                                            <div class="ads_view_header">
                                                ...
                                                <div class="row toggle_btn">
                                                    <label class="switch">
                                                        <input type="checkbox" id="checked1" name="banner_ad" value="true" class="cbx hidden" <?php if ($settings_data['banner_ad'] == 'true') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                } ?> />
                                                        <span class="slider round"></span>
                                                    </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="ads_view">
                                            <div class="ads_view_header">
                                                ...
                                                <div class="row toggle_btn">
                                                    <label class="switch">
                                                        <input type="checkbox" id="checked2" name="interstital_ad" value="true" class="cbx hidden" <?php if ($settings_data['interstital_ad'] == 'true') {
                                                                                                                                                        echo 'checked';
                                                                                                                                                    } ?> />
                                                        <span class="slider round"></span>
                                                    </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="ads_view">
                                            <div class="ads_view_header">
                                                ...
                                                <div class="row toggle_btn">
                                                    <label class="switch">
                                                        <input type="checkbox" id="checked4" name="native_ad" value="true" class="cbx hidden" <?php if ($settings_data['native_ad'] == 'true') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                } ?> />
                                                        <span class="slider round"></span>
                                                    </label>
                                    ...
                                    <div class="col-md-4">
                                        <div class="ads_view">
                                            <div class="ads_view_header">
                                                ...
                                                <div class="row toggle_btn">
                                                    <label class="switch">
                                                        <input type="checkbox" id="checked2" name="ads_limits" value="true" class="cbx hidden" <?php if ($settings_data['ads_limits'] == 'true') {
                                                                                                                                                    echo 'checked';
                                                                                                                                                } ?> />
                                                        <span class="slider round"></span>
                                                    </label>
